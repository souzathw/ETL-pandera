...
from src.contrato import MetricasFinanceirasBase #Buscando a classe cotrato


#Simulacao de dataframe por diferentes formas para identificar como o codigo se comporta em relação ao contrato.
#Serve para verificar se o contrato desenvolvido está correto. 
...
def test_coluna_adicional():
    ...
    with pytest.raises(pa.errors.SchemaError):
        MetricasFinanceirasBase.validate(df_test) #Passa o dataframe para validar
