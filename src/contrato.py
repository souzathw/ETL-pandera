...
class MetricasFinanceirasBase(pa.DataFrameModel):
    ...
    @pa.check(  # Validacao dos Setores no dataframe a nivel de coluna
        "setor_da_empresa",
...
class MetricasFinanceirasOut(MetricasFinanceirasBase): #Herdando a classe
    ...
    @pa.dataframe_check #Validação no dataframe das colunas entre si
